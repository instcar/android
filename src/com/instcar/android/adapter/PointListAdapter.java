...
public class PointListAdapter extends BaseAdapter {
	private List<NetDataEntry> list = null;
	private Context mContext;
	
	public PointListAdapter(Context mContext, List<NetDataEntry> list) {
	 ...
	 * @param list
	 */
	public void updateListView(List<NetDataEntry> list){
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		NetDataEntry entry = list.get(position);
		if (view == null) {
